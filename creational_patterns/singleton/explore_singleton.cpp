...
private:
    SingletonDatabase(){                                    // 1. private constructor.
        std::cout << "initializing database" << std::endl;

        std::ifstream ifs("/Users/user/CLionProjects/experimental/creational_patterns/singleton/capitals.txt");
...
public:
    ...
    SingletonDatabase(SingletonDatabase const&) = delete;   // 2. delete the copy constructor
    void operator=(SingletonDatabase const&) = delete;      // 3. delete the copy assignment
...
//    }
    ...
    static SingletonDatabase& get() {
        static SingletonDatabase db;    // Safe Singleton: this invacation will only happen once! So thread safe!
        return db;
    }
...
class improved_SingletonDatabase : public Database {
private:
